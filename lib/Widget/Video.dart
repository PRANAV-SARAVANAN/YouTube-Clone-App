...
class VideoWidget extends StatelessWidget {
  ...
  Video video;
  VideoWidget({required Key key, required this.video}) : super(key: key);
  // This widget is the root of your application.
  @override
  Widget build(BuildContext context) {
    print(video.thmupNail);
    return VideoWidgetPage(video: video, title: '',);
  }
}

class VideoWidgetPage extends StatefulWidget {
  VideoWidgetPage({required this.video, required this.title});
